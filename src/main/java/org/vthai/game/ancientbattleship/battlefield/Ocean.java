...
public class Ocean {
   ...
   private ComparisonValidatorImpl<Integer> rangeValidator;

   @Inject
   public Ocean(@Named(ValidatorModule.oceanRangeValidatorId) ComparisonValidatorImpl<Integer> rangValidator, 
